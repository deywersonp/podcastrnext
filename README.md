<h1 align="center">
  <img alt="Podcastr Logo" title="Podcastr Logo" src=".github/logo.png" width="220px" />
</h1>
...
![image](https://user-images.githubusercontent.com/79553681/127787593-b295b12e-8a30-4dcc-a303-6bea5fd39c13.png)
...
`yarn server` To run the fake API. <br>
...
`yarn build` To build the app. <br>
...
![Homepage_shuffle_repeat_image](.github/home-playing-shuffle-repeat.png)

### 2 - Episode page.
#### 2.1 - Also here you can play episode;
#### 2.2 - Come back to home page.
![Episodes_information_image](.github/episode-page.png)
